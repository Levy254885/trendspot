...
export function NewsRail({
  ...
  return (
    <section className="mb-8 grid grid-cols-1 gap-8 border-b border-border pb-8 lg:grid-cols-[1fr_260px] lg:gap-0">
        ...
        <div className="flex flex-col">
          {latest.map((story) => (
            <Link
              ...
              className="group grid grid-cols-[1fr_96px] gap-4 border-b border-border2 py-4 last:border-b-0 sm:grid-cols-[1fr_110px]"
            >
              <div className="min-w-0">
                <div className="mb-1 text-[9.5px] font-bold uppercase tracking-[0.12em] text-red">
                  {story.category}
                </div>
                <div className="mb-1 font-[family-name:var(--font-bask)] text-[14px] font-bold leading-[1.3] text-black group-hover:text-red sm:text-[15px]">
                  {story.title}
                </div>
